...
#ifndef __HALRF_8822E_H__
#define __HALRF_8822E_H__

#define AVG_THERMAL_NUM_8822E 4
#define RF_T_METER_8822E 0x42
#define DACK_REG_8822E 16
#define DACK_RF_8822E 1
void halrf_rf_lna_setting_8822e(
	struct dm_struct *p_dm_void,
	enum halrf_lna_set type);

void configure_txpower_track_8822e(
	struct txpwrtrack_cfg *config);

void odm_tx_pwr_track_set_pwr8822e(
	void *dm_void,
...
void get_delta_swing_table_8822e_ex(
	void *p_dm_void,
	u8 **temperature_up_c,
...
void phy_set_rf_path_switch_8822e(
...
void halrf_dack_restore_8822e(void *dm_void);

void halrf_rfk_power_save_8822e(void *dm_void, boolean is_power_save);

void halrf_lck_track_8822e(void *dm_void);

u8 halrf_get_thermal_8822e(void *dm_void, u8 path);

void halrf_rxspurk_8822e(struct dm_struct *dm);
