...
#define YT_LINUX_SUBVERSION 	7290
#define YT_LINUX_VERSIONID  	"2.2.7290"
...
#define YT8512_LED_BT_BLK_EN		0x0002
#define YT8512_LED_HT_BLK_EN		0x0004
#define YT8512_LED_COL_BLK_EN		0x0008
#define YT8512_LED_BT_ON_EN		0x0010
#define YT8512_LED_HT_ON_EN		0x0020
#define YT8512_LED_RXACT_ON_EN		0x0040
#define YT8512_LED_TXACT_ON_EN		0x0080
#define YT8512_LED_RXACT_BLK_EN	0x0100
#define YT8512_LED_TXACT_BLK_EN	0x0200
#define YT8512_LED_HDX_ON_EN		0x0400
#define YT8512_LED_FDX_ON_EN		0x0800
#define YT8512_LED_ACT_BLK_IND		0x1000
...
static int yt8512_led_init(struct phy_device *phydev)
{
	...
	val |= YT8512_LED_BT_ON_EN | YT8512_LED_HT_ON_EN;

	mask = YT8512_LED_BT_BLK_EN | YT8512_LED_HT_BLK_EN |
		YT8512_LED_TXACT_BLK_EN | YT8512_LED_RXACT_BLK_EN |
		YT8512_LED_COL_BLK_EN | YT8512_LED_ACT_BLK_IND;
	...
	val |= YT8512_LED_ACT_BLK_IND;

	mask = YT8512_LED0_DIS_LED_AN_TRY | YT8512_LED_BT_BLK_EN |
		YT8512_LED_HT_BLK_EN | YT8512_LED_COL_BLK_EN |
		YT8512_LED_BT_ON_EN;
				...
				struct ethtool_wolinfo *wol)
{
    ...
    printk("zc:ytphy_wol_feature_set ==\n");
	...
	if (wol->wolopts & WAKE_MAGIC) {
		printk("zc:ytphy_wol_feature_set enable ==\n");
...
static int yt8531_read_status(struct phy_device *phydev)
{
	...
	if (link) {
    	...
    	ret = ytphy_write_ext(phydev, YT8531_LED_GENERAL_CFG, 0xF020);
				if (ret < 0)
					return ret;
